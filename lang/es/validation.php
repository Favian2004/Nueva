...
return [
    ...
    | versiones, como las de tamaño (size). Siéntete libre de ajustarlas
    | a lo que necesite tu aplicación.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Líneas de idioma para atributos personalizados
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para cambiar el marcador :attribute a
    | algo más amigable, como "Dirección de Correo" en vez de "email".
    |
    */
    ...
    'attributes' => [
        ...
        'publicante' => 'nombre del publicante',
        'trabajadores_requeridos' => 'trabajadores requeridos',
        'fecha_trabajo' => 'día del trabajo',
        'duracion' => 'duración',
