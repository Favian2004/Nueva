...
<head>
  ...
  <!-- Para Android/Chrome -->
  <link rel="icon" href="{{ asset('img/template/acer.png') }}" type="image/png" sizes="192x192">
...
======================================-->
    ...
    <section class="py-5">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            <!-- w-75 = 75% de ancho, w-100 = 50%, w-100 = 100% (por defecto) -->
            <img src="{{ asset('img/about/CAMPESINOS.jpg') }}" class="img-fluid rounded-4 shadow w-100" alt="Nuestra historia"
              onerror="this.src='https://via.placeholder.com/600x400?text=Nuestra+Historia'">
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-5 bg-light">
      <div class="container">
        <h2 class="text-center fw-bold mb-5" style="color: #2c3e50;">Lo que nos define</h2>
        ...
        <div class="row g-4">
          ...
          <div class="col-md-4">
            <div class="card mission-card text-center p-4 h-100">
              ...
              <p>Confianza, transparencia, calidad y compromiso con nuestra comunidad.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="py-5">
      <div class="container">
        <h2 class="text-center fw-bold mb-5" style="color: #2c3e50;">¿Qué ofrecemos?</h2>
    ...
    <section class="py-5" style="background: #F38F3A;">
      <div class="container text-center text-white">
        ...
        <p class="lead mb-4">Únete a nuestra comunidad y encuentra lo que necesitas</p>
        <a href="#" class="btn dropdown-categorias btn-lg px-4 me-2">Ofrecer Servicio</a>
        <a href="#" class="btn dropdown-categorias btn-lg px-4">Contratar</a>
      </div>
    </section>
      ...
      <div class="container py-5">
        ...
        <div class="row g-4">
          ...
          <div class="col-md-4 text-center text-md-end">
            ...
            <p><i class="bi bi-telephone"></i> 2331150303</p>
