...
<body>
    <div id="app">
        ...
        <style>
            ...
            .modal-postular .delete:hover {
                background: rgba(255, 255, 255, 0.45) !important;
            }

            #btnEnviarPostulacion:hover {
                opacity: 0.9;
        ...
        <style>
            ...
            @media (max-width: 767px) {
                ...
                .btn-anunciar {
                    ...
                    border-radius: 30px;
                    text-align: center;
                    box-shadow: 0 6px 16px rgb(250, 248, 244);
    ...
    <script>
            ...
            fetch(`/usuario/empleador/postulacion-borrador/${vacanteId}`, {
                ...
                .then(({
                    ...
                    fetch(`/usuario/postulantes/${postulacionBorradorId}/cv/estado`)
                        ...
                        .then(estado => {
                            if (estado.ok) {
                                miTieneCvEnBorrador = estado.tieneCv;
                                miTieneSolicitudEnBorrador = estado.tieneSolicitud;
                            }
                            pintarDocsModal();
        ...
        function iniciarConsultaEstado() {
            ...
            pollIntervalId = setInterval(() => {
                ...
                fetch(`/usuario/postulantes/${postulacionBorradorId}/cv/estado`)
                    ...
                    .catch(() => {
                        /* ignorar, reintenta en el próximo intervalo */ });
            }, 2000);
        }
        ...
        function subirCvDesdeModal(input) {
            ...
            fetch(`/usuario/postulantes/${postulacionBorradorId}/cv/subir-archivo`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': csrfToken
                    },
                ...
                .then(({
                    ...
                    if (!ok) {
                        alert('❌ Ocurrió un error al subir tu CV.');
                        return;
                    }
        ...
        function subirSolicitudDesdeModal(input) {
            ...
            const fd = new FormData();
            fd.append('archivo', file);
            fetch(`/usuario/postulantes/${postulacionBorradorId}/solicitud-empleo`, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': csrfToken
                    },
                ...
                .then(({
                    ...
                    if (!ok) {
                        alert('❌ Ocurrió un error al subir tu Solicitud de Empleo. Confirma que sea un PDF.');
                        return;
                    }
